...
import { CASE_DATA_VERIFIED_AT, formatVerifiedDate, casePeriodCutoff, localDateKey } from "../lib/privacy-risk/dates";
...
export default function Home() {
  ...
  const filteredCases = useMemo(() => {
    const cutoff = casePeriodCutoff(casePeriod);
    return caseRecords
